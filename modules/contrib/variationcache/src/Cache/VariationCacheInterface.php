 ...
 */
if (!class_exists('\Drupal\Core\Cache\VariationCacheInterface')) {
  @class_alias('\Drupal\variationcache\Old\Cache\VariationCacheInterface', '\Drupal\variationcache\Cache\VariationCacheInterface');
}
else {
