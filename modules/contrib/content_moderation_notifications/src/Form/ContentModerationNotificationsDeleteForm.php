 ...
 * ContentModerationNotificationFormBase. The reason for
 ...
 */
class ContentModerationNotificationsDeleteForm extends EntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.content_moderation_notification.collection');
  }
